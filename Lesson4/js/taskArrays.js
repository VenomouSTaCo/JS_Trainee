...
function reverseSortString(str) {
    return console.log(str.split("").sort().reverse().join(""));
}

reverseSortString('bcdaeflmjgkhi')
...
function getNewArray(arr, first, last) {
    let newArr = arr.splice(first, last - first + 1);
...
insertValue(['I', 'am', 'an', 'array'], 'awesome')
...
function coreSort(arrObj) {
    return console.log(arrObj.sort(function (prev, next) {
